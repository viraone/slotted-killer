...
assert.equal(occurs(9, 15), true, 'Third Tuesday (comedy) is active');
assert.equal(occurs(9, 8), true, 'Second Tuesday (mixed mic) is active');
assert.equal(occurs(9, 22), true, 'Fourth Tuesday (mixed mic) is active');
...
assert.equal(occurs(10, 20), true, 'Third Tuesday recurs next month');
